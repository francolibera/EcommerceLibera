...
<body>
   <nav class="navbar has-shadow is-spaced is-warning" role="navigation" aria-label="main navigation">
		        ...
		        <div class="box">
                    ...
                    <label class="label">N�mero de Tarjeta:</label>
		                ...
		                <div class="field">
		                    ...
		                    <div class="control">
		                        <input class="input" type="text" name="cvvTarjeta" required pattern="\d{3,4}" title="3 o 4 d�gitos">
		                    </div>
		                </div>
		                <div class="field">
	    ...
	    <div class="modal-background"></div>
		    <div class="modal-content">
		        <div class="box">
		            ...
		            <form id="agregarSaldoForm" action="Controller?accion=A�adirSaldo" method="post">
		                <div class="field">
		                    <label class="label">N�mero de Tarjeta:</label>
		                    <div class="control">
	...
	<div class="modal" id="confirmacionModal">
	    ...
	    <div class="modal-content">
	        <div class="box">
	            <h3 class="title is-4">Confirmaci�n</h3>
...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    document.getElementById('agregarSaldoForm').addEventListener('submit', function(e) {
        ...
        if (this.checkValidity()) {
            ...
            fetch('Controller?accion=A�adirSaldo', {
                method: 'POST',
                body: formData
            })
            ...
            .catch(error => {
                ...
                alert('Ocurri� un error al agregar el saldo');
            });
        } else {
            alert('Por favor, complete todos los campos correctamente.');
        }
